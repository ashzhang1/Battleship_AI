...
for test in range(0,num_tests):
    ...
    p1ShipPos = [[(3,1), (4,1),(5,1)], 
                    ...
                    [(0,9), (1,9), (2,9)], 
                    [(5,9), (6,9)]]
    p1ShipPos = ship_picker.getShipPos()
    ...
    p2ShipPos = [[(3,1), (4,1),(5,1)], 
                    ...
                    [(0,9), (1,9), (2,9)], 
                    [(5,9), (6,9)]]
    p2ShipPos = ship_picker.getShipPos()
    # Coordinates on the board:
    #           [[(4, 2), (5, 2), (6, 2)],
    #           [(3, 2), (3, 3), (3, 4), (3, 5), (3, 6)], 
    #           [(8, 8), (9, 8)], 
    ...
    number_moves.append(len(p1ShotSeq))
...
print("Results: ", results/num_tests)
print(sum(number_moves)/len(number_moves))